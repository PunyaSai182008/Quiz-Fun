...
function setup() {
    ...
    textStyle(BOLD);
    fill("white");
    text("Test Your General Knowledge", 150, 150,);
    pop();
    textSize(30)
    fill("white")
    text("Enter Your Name: ", 475, 350)
    login = createInput("");
    login.position(720, 330)
...
function greetingpage() {
    ...
    greeting.position(481, 112);
    greeting.style("color", "dodgerblue")
    greeting.style("font-size", "50px")
    startQuiz = createButton("Start Quiz")
    startQuiz.style("color", "#e951a5")
    startQuiz.style("background-color", "#00dcff")
    startQuiz.style("font-size", "25px");
    startQuiz.style("border-radius","30px")
    startQuiz.style("border-color","aquamarine")
    startQuiz.position(620, 355);
...
function question1() {
    ...
    q1a.style("border-radius","26px")
    q1a.position(402, 250);

    if(q1a.mousePressed(q1Option1Ans)){
        nextbutton.show
    }else{
        nextbutton.hide();
    }
    ...
    nextbutton.mouseClicked(question2);
...
function question2() {
    ...
    nextbutton.style("border-radius","10px")
    nextbutton.position(402, 500);
    nextbutton.mouseClicked(question3);
